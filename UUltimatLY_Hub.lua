...
Window = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))():CreateWindow({
    ["Title"] = "UUltimatLY Hub [ Free ] By realryzu",
    ["SubTitle"] = "",
    ["TabWidth"] = 155,
...
print("\226\156\133 Smooth + Stable Anti-Lag Activated - Made by realryzu")
game.StarterGui:SetCore("SendNotification", {
    ["Title"] = "UPDATE!",
    ["Text"] = "Reduce Lag And Fixed Some Functions",
    ["Icon"] = "rbxassetid://5009915795",
    ["Duration"] = 8
})